...
//       Button bsimpan;
//  EditText namaPerusahaan, namaPimpinan, email, mobile;
//    TextView thasil;
//    Spinner bidangUsaha, bidangJasa;
//
//    @Override
...
//
//        // inisialisasi
//        bsimpan = (Button) findViewById(R.id.btnSubmit);
//        namaPimpinan = (EditText) findViewById(R.id.txtNamaPimpinan);
//        mobile = (EditText) findViewById(R.id.txtMobile);
//        email = (EditText) findViewById(R.id.txtEmail);
//        bidangUsaha = (Spinner) findViewById(R.id.pilJK);
//        bidangJasa  = (Spinner) findViewById(R.id.pilJK2);
//
